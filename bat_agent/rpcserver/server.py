...
class RPCServer:
    def __init__(self, cfg):
        ...
        self._server_cfg = cfg[Constant.CONFIG_RPC_SECTION]
        self._connection = None
        self._channel = None
        self._closing = False
        self._consumer_tag = None
        self.QUEUE = self._server_cfg['queue']
        self.ROUTING_KEY = self._server_cfg['routing_key']
        self.EXCHANGE = self._server_cfg['exchange']
        self.DELETE_QUEUE = self._rabbit_cfg["delete_queue_on_close"]
    ...
    def on_channel_closed(self, channel, reply_code, reply_text):
        ...
        if self.DELETE_QUEUE == "True":
            self._channel.queue_delete(queue=self.QUEUE)
        LOGGER.info('Deleting queue %s', self.QUEUE)
