...
import simplejson
import signal
from bat_agent.listener.server import AgentListener
from daemon import batListenerDaemon
...
class DefaultListenerServer(batListenerDaemon, AgentListener):
    def __init__(self, cfg):
        batListenerDaemon.__init__(self, cfg[Constant.CONFIG_PIDFILE_SECTION]["listener"])
